package me.freakjoost.Dabois.command;

import java.util.HashMap;
import java.util.Map;

import me.freakjoost.Dabois.Dabois;
import me.freakjoost.Dabois.command.commands.BindCommand;
import me.freakjoost.Dabois.command.commands.HelpCommand;
import me.freakjoost.Dabois.command.commands.ToggleCommand;
import me.freakjoost.Dabois.command.commands.XRayCommand;
...
public class CommandManager {
    ...
    public void loadCommands() {
        ...
        commands.put(new String[]{"xray", "x"}, new XRayCommand());
    }
