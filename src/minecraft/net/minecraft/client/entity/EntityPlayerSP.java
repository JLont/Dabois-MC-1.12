...
import me.freakjoost.Dabois.event.events.EventMotion;
import me.freakjoost.Dabois.event.events.EventMove;
import me.freakjoost.Dabois.event.events.EventSlowDown;
...
public class EntityPlayerSP extends AbstractClientPlayer
{
    ...
    public void moveEntity(MoverType x, double xPos, double yPos, double zPos) {
        EventMove move = new EventMove(xPos, yPos, zPos);
        move.call();
        super.moveEntity(x, move.x, move.y, move.z);
    }
